...
Course Code: EEE227 Programme: HND Electrical Engineering (Level 200)
Description
...
Register students View all students Search for students Create session (Date/Time/Duration) Mark attendance (Present/Absent/Late) View session attendance report Persistent storage using files
How It Works
...
digital-attendance-system/ │── main.cpp │── students.txt │── sessions/ │ └── session_code_date.txt │── README.md
How to Build
...
./attendance
Author
Jonas Abakah-Williams 01241328D
